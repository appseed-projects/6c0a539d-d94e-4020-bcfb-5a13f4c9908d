...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-08 11:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6c0a539d-d94e-4020-bcfb-5a13f4c9908d.git
$ cd 6c0a539d-d94e-4020-bcfb-5a13f4c9908d
```
